...
/**
 * Validates a PushDrop transaction output
 *
...
module.exports = async ({
  ...
  let unlockingScript  = bsv.Script.buildPublicKeyIn(
    signature,
    signature.nhashtype
  ).toHex()
  if (unlockingScript) {
    // TODO: How can we know an PushDrop unlocking script will actually unlock a UTXO?
    // Maybe decode and compare the fields as well to make sure they match up with what is expected?
    return true
  }
  return false
}
