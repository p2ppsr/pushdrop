/* eslint-env jest */
const getP2PKUnlockingScript = require('../getP2PKUnlockingScript')
...
describe('getP2PKUnlockingScript', () => {
  it('Returns a script', () => {
    const returnValue = getP2PKUnlockingScript({
      prevTxId: fakeTxid,
      outputIndex: 2,
  ...
  it('Returns a script with signSingleOutput', () => {
    const returnValue = getP2PKUnlockingScript({
      prevTxId: fakeTxid,
      outputIndex: 2,
      lockingScript: pushDropUnlockableScript,
